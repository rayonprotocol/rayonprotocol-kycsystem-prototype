...
contract('AddressBoolIterableMap', function (accounts) {
    ...
    before('setup contract for each test', async () => {
        addressBoolIterableMapContract = await AddressBoolIterableMapImpl.new();
    ...
    it("Add first account", async () => {
        ...
        await addressBoolIterableMapContract.add(account1, true);
    ...
    it("Add first & second accounts", async () => {
        ...
        // add second account
        await addressBoolIterableMapContract.add(account2, true);
    ...
    it("Add third & fourth accounts", async () => {
        ...
        // add third account
        await addressBoolIterableMapContract.add(account3, true);
        ...
        // add fourth account
        await addressBoolIterableMapContract.add(account4, true);
